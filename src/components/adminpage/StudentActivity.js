...
class StudentActivity extends Component {
  ...
  componentDidMount() {
    ...
    this.props.getActivityStudentList({ skip: 0, limit: 10, A_ID: this.props.match.params.aid });
  }
  fetchMoreData = () => {
    console.log("getITem");
    this.props.getActivityStudentList({
    ...
    return (
      <div className="mt-5">
        <h1 className="text-center mb-5">
          Danh Sách Các Sinh Viên Tham Gia Hoạt Động
        </h1>
